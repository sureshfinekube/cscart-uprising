...
$config['db_name'] = 'cs_cart_demo';
$config['db_user'] = 'suresh';
$config['db_password'] = '369963';

$config['database_backend'] = 'mysqli';

// Database tables prefix
$config['table_prefix'] = 'fk_';
...
$config['http_host'] = 'uprisingrivals.in';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'uprisingrivals.in';
$config['https_path'] = '';
